...
.method public getClusters(D)Ljava/util/Set;
    ...
    .line 62
    new-instance v10, Lcom/google/maps/android/projection/SphericalMercatorProjection;

    long-to-double v4, v2

    invoke-direct {v10, v4, v5}, Lcom/google/maps/android/projection/SphericalMercatorProjection;-><init>(D)V
    ...
    .line 67
    iget-object v13, v1, Lcom/google/maps/android/clustering/algo/GridBasedAlgorithm;->mItems:Ljava/util/Set;
    ...
    check-cast v15, Lcom/google/maps/android/clustering/ClusterItem;
    ...
    invoke-virtual {v10, v4}, Lcom/google/maps/android/projection/SphericalMercatorProjection;->toPoint(Lcom/google/android/gms/maps/model/LatLng;)Lcom/google/maps/android/projection/Point;

    move-result-object v8

    .line 71
    iget-wide v6, v8, Lcom/google/maps/android/geometry/Point;->x:D

    iget-wide v4, v8, Lcom/google/maps/android/geometry/Point;->y:D
    ...
    .line 73
    invoke-virtual {v12, v4, v5}, Landroid/support/v4/util/LongSparseArray;->get(J)Ljava/lang/Object;
    ...
    iget-wide v8, v1, Lcom/google/maps/android/geometry/Point;->x:D
    ...
    invoke-virtual {v10, v7}, Lcom/google/maps/android/projection/SphericalMercatorProjection;->toLatLng(Lcom/google/maps/android/geometry/Point;)Lcom/google/android/gms/maps/model/LatLng;
    ...
    .line 79
    :goto_1
    invoke-virtual {v6, v15}, Lcom/google/maps/android/clustering/algo/StaticCluster;->add(Lcom/google/maps/android/clustering/ClusterItem;)Z
