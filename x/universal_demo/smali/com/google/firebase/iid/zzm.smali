...
.field final zzbqz:Landroid/os/Messenger;

.field zzbra:Lcom/google/firebase/iid/zzr;

.field final zzbrb:Ljava/util/Queue;
...
.field final zzbrc:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field final synthetic zzbrd:Lcom/google/firebase/iid/zzk;
...
.method private constructor <init>(Lcom/google/firebase/iid/zzk;)V
    ...
    iput-object p1, p0, Lcom/google/firebase/iid/zzm;->zzbrd:Lcom/google/firebase/iid/zzk;
    ...
    iput-object p1, p0, Lcom/google/firebase/iid/zzm;->zzbqz:Landroid/os/Messenger;

    new-instance p1, Ljava/util/ArrayDeque;

    invoke-direct {p1}, Ljava/util/ArrayDeque;-><init>()V

    iput-object p1, p0, Lcom/google/firebase/iid/zzm;->zzbrb:Ljava/util/Queue;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lcom/google/firebase/iid/zzm;->zzbrc:Landroid/util/SparseArray;
...
.method private final zzsq()V
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzm;->zzbrd:Lcom/google/firebase/iid/zzk;
...
.method public final declared-synchronized onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/firebase/iid/zzm;->zzb(ILjava/lang/String;)V
    :try_end_0
    ...
    iput-object v1, p0, Lcom/google/firebase/iid/zzm;->zzbra:Lcom/google/firebase/iid/zzr;
    :try_end_1
    ...
    invoke-direct {p0}, Lcom/google/firebase/iid/zzm;->zzsq()V
    :try_end_2
...
.method public final declared-synchronized onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/firebase/iid/zzm;->zzb(ILjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final zza(Landroid/os/Message;)Z
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/iid/zzm;->zzbrc:Landroid/util/SparseArray;
    ...
    :cond_1
    iget-object v3, p0, Lcom/google/firebase/iid/zzm;->zzbrc:Landroid/util/SparseArray;

    invoke-virtual {v3, v0}, Landroid/util/SparseArray;->remove(I)V

    invoke-virtual {p0}, Lcom/google/firebase/iid/zzm;->zzsr()V
    ...
    :cond_2
    invoke-virtual {v1, p1}, Lcom/google/firebase/iid/zzt;->zzh(Landroid/os/Bundle;)V
...
.method final declared-synchronized zzae(I)V
    .locals 4

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzm;->zzbrc:Landroid/util/SparseArray;
...
.method final declared-synchronized zzb(ILjava/lang/String;)V
    .locals 4
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/zzm;->zzbrd:Lcom/google/firebase/iid/zzk;
    ...
    iget-object p1, p0, Lcom/google/firebase/iid/zzm;->zzbrb:Ljava/util/Queue;
    ...
    check-cast p2, Lcom/google/firebase/iid/zzt;

    invoke-virtual {p2, v0}, Lcom/google/firebase/iid/zzt;->zza(Lcom/google/firebase/iid/zzu;)V
    ...
    :goto_2
    iget-object p2, p0, Lcom/google/firebase/iid/zzm;->zzbrc:Landroid/util/SparseArray;
    ...
    :cond_4
    iget-object p1, p0, Lcom/google/firebase/iid/zzm;->zzbrc:Landroid/util/SparseArray;
...
.method final declared-synchronized zzb(Lcom/google/firebase/iid/zzt;)Z
    ...
    :pswitch_1
    :try_start_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzm;->zzbrb:Ljava/util/Queue;
    ...
    iget-object v3, p0, Lcom/google/firebase/iid/zzm;->zzbrd:Lcom/google/firebase/iid/zzk;
    ...
    invoke-virtual {p0, v1, p1}, Lcom/google/firebase/iid/zzm;->zzb(ILjava/lang/String;)V

    goto :goto_1

    :cond_2
    iget-object p1, p0, Lcom/google/firebase/iid/zzm;->zzbrd:Lcom/google/firebase/iid/zzk;
...
.method final declared-synchronized zzsr()V
    .locals 2
...
.method final declared-synchronized zzss()V
    .locals 2
    ...
    invoke-virtual {p0, v1, v0}, Lcom/google/firebase/iid/zzm;->zzb(ILjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
