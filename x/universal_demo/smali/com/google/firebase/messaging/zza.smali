...
# static fields
.field private static zzbsg:Lcom/google/firebase/messaging/zza;


# instance fields
.field private zzbsh:Landroid/os/Bundle;

.field private zzbsi:Ljava/lang/reflect/Method;

.field private zzbsj:Ljava/lang/reflect/Method;

.field private final zzbsk:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/zza;->zzbsk:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/messaging/zza;->zzqs:Landroid/content/Context;
...
.method private final zza(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    iget-object v1, p0, Lcom/google/firebase/messaging/zza;->zzqs:Landroid/content/Context;
    ...
    iget-object p1, p0, Lcom/google/firebase/messaging/zza;->zzbsi:Ljava/lang/reflect/Method;

    if-nez p1, :cond_6

    const-string p1, "setChannelId"

    invoke-static {p1}, Lcom/google/firebase/messaging/zza;->zzfh(Ljava/lang/String;)Ljava/lang/reflect/Method;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/messaging/zza;->zzbsi:Ljava/lang/reflect/Method;
...
.method private final zzaf(I)Z
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/firebase/messaging/zza;->zzqs:Landroid/content/Context;
...
.method private final zzd(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/google/firebase/messaging/zza;->zzqs:Landroid/content/Context;
...
.method private static zzfh(Ljava/lang/String;)Ljava/lang/reflect/Method;
    .locals 4
    .annotation build Landroid/annotation/TargetApi;
        value = 0x1a
    .end annotation
...
.method private final zzfi(Ljava/lang/String;)Ljava/lang/Integer;
    .locals 4
    ...
    :cond_1
    invoke-direct {p0}, Lcom/google/firebase/messaging/zza;->zzti()Landroid/os/Bundle;
    ...
    :try_start_1
    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->zzqs:Landroid/content/Context;
...
.method private final zzfj(Ljava/lang/String;)Ljava/lang/String;
    .locals 10
    .annotation build Landroid/annotation/TargetApi;
        value = 0x1a
    .end annotation
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/firebase/messaging/zza;->zzbsj:Ljava/lang/reflect/Method;
    ...
    iput-object v2, p0, Lcom/google/firebase/messaging/zza;->zzbsj:Ljava/lang/reflect/Method;
    ...
    :goto_1
    iget-object p1, p0, Lcom/google/firebase/messaging/zza;->zzbsj:Ljava/lang/reflect/Method;
    ...
    iget-object v8, p0, Lcom/google/firebase/messaging/zza;->zzqs:Landroid/content/Context;
...
.method static zzl(Landroid/os/Bundle;)Z
    .locals 2
...
.method static zzm(Landroid/os/Bundle;)Landroid/net/Uri;
    .locals 2
...
.method static zzo(Landroid/os/Bundle;)Ljava/lang/String;
    .locals 2
...
.method private final zzti()Landroid/os/Bundle;
    .locals 4

    iget-object v0, p0, Lcom/google/firebase/messaging/zza;->zzbsh:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/zza;->zzbsh:Landroid/os/Bundle;
...
.method static declared-synchronized zzw(Landroid/content/Context;)Lcom/google/firebase/messaging/zza;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/zza;->zzbsg:Lcom/google/firebase/messaging/zza;
    ...
    sput-object v1, Lcom/google/firebase/messaging/zza;->zzbsg:Lcom/google/firebase/messaging/zza;

    :cond_0
    sget-object p0, Lcom/google/firebase/messaging/zza;->zzbsg:Lcom/google/firebase/messaging/zza;
    :try_end_0
...
# virtual methods
.method final zzn(Landroid/os/Bundle;)Z
    .locals 13
    ...
    iget-object v3, p0, Lcom/google/firebase/messaging/zza;->zzqs:Landroid/content/Context;
    ...
    iget-object v7, p0, Lcom/google/firebase/messaging/zza;->zzqs:Landroid/content/Context;
    ...
    invoke-direct {p0, v6}, Lcom/google/firebase/messaging/zza;->zzaf(I)Z
    ...
    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/zza;->zzaf(I)Z
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/zza;->zzaf(I)Z
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/zza;->zzfi(Ljava/lang/String;)Ljava/lang/Integer;

    move-result-object v7

    invoke-static {p1}, Lcom/google/firebase/messaging/zza;->zzo(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    iget-object v10, p0, Lcom/google/firebase/messaging/zza;->zzqs:Landroid/content/Context;
    ...
    :cond_f
    invoke-static {p1}, Lcom/google/firebase/messaging/zza;->zzm(Landroid/os/Bundle;)Landroid/net/Uri;
    ...
    iget-object v9, p0, Lcom/google/firebase/messaging/zza;->zzqs:Landroid/content/Context;
    ...
    invoke-static {v10}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzp(Landroid/os/Bundle;)V
    ...
    iget-object v11, p0, Lcom/google/firebase/messaging/zza;->zzbsk:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :goto_5
    invoke-static {p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzq(Landroid/os/Bundle;)Z
    ...
    iget-object v10, p0, Lcom/google/firebase/messaging/zza;->zzbsk:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v10}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    move-result v10

    invoke-static {v9, v10, v8, v3}, Lcom/google/firebase/iid/zzz;->zza(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v10, v11, v9, v3}, Lcom/google/firebase/iid/zzz;->zza(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/zza;->zzfj(Ljava/lang/String;)Ljava/lang/String;
